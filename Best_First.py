...
class Best_First():
    ...
    def solve_puzzle(self):
        ...
        self.summary = 'The Best First algorithm touched {} different game states before finding the solution. The solution can be reached in {} moves'.format(str(len(self.close)), str(self.open[0].depth-1))
