...
class PuzzleNode_Breadth_First():
    ...
    def clone_puzzle(self):
        ...
        sets parent to self.
        '''
        new_puzzle_node = PuzzleNode_Breadth_First(self,[])
...
class Breadth_First():
    def __init__(self):
        ...
        self.close = []
        self.summary = ''
        self.root_puzzle_node = PuzzleNode_Breadth_First(None,[])
        self.assign_random_puzzle(self.root_puzzle_node)


    def solve_puzzle(self):
        '''
        Solve the eight puzzle problem by using the Breadth First searching
        algorithm.
        '''
        ...
        print('Solved with Breadth First')
        print(self.open[0].grid[0])
        print(self.open[0].grid[1])
        print(self.open[0].grid[2])
        self.summary = 'The Breadth First algorithm touched {} different game states before finding the solution. The Solution can be reached in {} moves'.format(str(len(self.close)), str(self.open[0].depth-1))
